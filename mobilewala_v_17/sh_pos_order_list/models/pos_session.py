...
class PosSession(models.Model):
    ...
    def load_all_pos_order_lines(self):
        self.env.cr.execute(""" SELECT  ol.product_id,ol.id ,ol.qty ,ol.price_unit, ol.discount, ol.price_subtotal,ol.order_id, ol.price_subtotal_incl FROM pos_order_line ol
